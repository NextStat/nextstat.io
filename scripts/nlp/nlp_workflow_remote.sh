...
#
# Usage:
#   APEX2_HOST=myhost bash scripts/nlp/nlp_workflow_remote.sh
#   APEX2_HOST=v100          bash scripts/nlp/nlp_workflow_remote.sh
#
# Optional overrides:
#   APEX2_HOST
#   NLP_REMOTE_REPO (default: /workspace/nextstat.io)
...
APEX2_HOST="${APEX2_HOST:?Set APEX2_HOST to your remote benchmark host}"
NLP_REMOTE_REPO="${NLP_REMOTE_REPO:-/workspace/nextstat.io}"
