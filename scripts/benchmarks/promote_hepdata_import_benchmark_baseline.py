#!/usr/bin/env python3
"""Promote a vetted HEPData import benchmark artifact to the accepted baseline."""
...
SCHEMA_VERSION = "nextstat.hepdata_import_benchmark_baseline_promotion_report.v1"
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Promote a vetted HEPData import benchmark artifact to the accepted baseline.")
    ...
    shutil.copy2(args.current, promoted_archive)
