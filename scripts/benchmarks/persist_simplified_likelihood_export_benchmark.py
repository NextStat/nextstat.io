...
def _report(
    *,
    ...
    return {
        ...
        "current_dir": relative_or_absolute(current_dir),
        "current_benchmark_artifact_path": relative_or_absolute(current_benchmark_artifact_path),
        "current_report_path": relative_or_absolute(current_report_path),
        "current_snapshot_index_path": relative_or_absolute(current_snapshot_index_path),
        "history_dir": relative_or_absolute(history_dir),
