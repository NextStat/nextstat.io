...
def bench_ns_laps(model_name, n_chains, n_warmup, n_samples, seed, report_chains):
    import nextstat
    ...
    # - Funnel still benefits from more frequent DA sync and larger max_leapfrog.
    # - GLM logistic is now stable with default-style sync/caps; using the
    #   funnel settings here can over-penalize LAPS wall time in benchmarks.
