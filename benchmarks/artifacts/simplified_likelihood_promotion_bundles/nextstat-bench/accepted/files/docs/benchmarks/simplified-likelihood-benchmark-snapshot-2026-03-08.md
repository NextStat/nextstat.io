...
Exporter follow-up matrix summary (`nextstat-bench`, March 9, 2026 exporter refresh):

- export matrix included: `true`
- export matrix status: `ok`
- export matrix case count: `6`
- export matrix case kinds: `public_reinterpretation_style`, `synthetic`
- export matrix public reinterpretation-style case count: `4`
...
- export matrix max `q_mu` absolute difference: `0.07556543092300672`
- export matrix max upper-limit ratio deviation from `1.0`: `0.007335272543316007`
- export matrix overall minimum net end-to-end upper-limit speedup: `0.7938213855184941x`
- export matrix synthetic control minimum net end-to-end upper-limit speedup: `1.9819882502665878x`
- export matrix public reinterpretation-style minimum net end-to-end upper-limit speedup: `0.7938213855184941x`
...
- the committed exporter matrix now also includes three machine-classified public
