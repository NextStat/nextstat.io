...
8. the committed accepted exporter bundle includes a versioned
   ...
   workflow consumption for the accepted `5 public / 7 total` floor
...
- `export_matrix_min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
- `export_matrix_synthetic_min_net_end_to_end_upper_limit_speedup = 2.0821942313909845x`
- `public_validation.min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
