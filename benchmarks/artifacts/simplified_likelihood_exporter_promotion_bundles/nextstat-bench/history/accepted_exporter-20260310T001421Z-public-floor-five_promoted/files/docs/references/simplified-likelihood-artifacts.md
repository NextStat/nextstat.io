...
- current March 9, 2026 committed exporter evidence:
  ...
  - `export_matrix_public_reinterpretation_style_min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
