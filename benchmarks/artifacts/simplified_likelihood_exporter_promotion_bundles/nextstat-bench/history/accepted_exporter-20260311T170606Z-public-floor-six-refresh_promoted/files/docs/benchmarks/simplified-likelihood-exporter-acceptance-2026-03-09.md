...
8. the committed accepted exporter bundle includes a versioned
   ...
   workflow consumption for the accepted `6 public / 8 total` floor
...
- `export_matrix_min_net_end_to_end_upper_limit_speedup = 0.9434751728263177x`
- `export_matrix_synthetic_min_net_end_to_end_upper_limit_speedup = 2.0581999472135606x`
- `public_validation.min_net_end_to_end_upper_limit_speedup = 0.9434751728263177x`
