...
- committed exporter matrix case count is at least `8`
- committed exporter matrix includes at least `6 public reinterpretation-style cases`
...
The accepted `6 public / 8 total` floor is refreshed:
