...
| `nextstat config schema --name simplified_likelihood_exporter_stable_evidence_policy_v0` | `stable` | published machine-readable release-facing admission policy and maintenance cadence for the accepted `6 public / 8 total` exporter stable-evidence floor |
