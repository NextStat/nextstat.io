...
- which docs/workflows must move in lockstep when the `5 public / 7 total`
  floor changes
...
- `export_matrix_case_count >= 7`
- `public_reinterpretation_style` case count `>= 5`
...
but it must not be counted toward the accepted `5 public / 7 total` stable floor.
...
- `export_matrix_case_count = 7`
- `public_case_count = 5`
- `public_case_names = ["atlas_public_dual_sr_dual_cr_gaussian_export_stable_example", "atlas_public_sr_cr_gaussian_export_stable_example", "cms_public_sr_cr_export_stable_example", "cms_public_sr_cr_asymmetric_gaussian_export_stable_example", "cms_public_dual_sr_cr_gaussian_export_stable_example"]`
- `synthetic_min_net_end_to_end_upper_limit_speedup = 2.0821942313909845x`
- `public_min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
- `max_abs_q_mu_diff = 0.09089073579143658`
- `max_upper_limit_ratio_deviation = 0.0093663653819136`
- `cases_outside_promoted_stable_runtime_boundary = 0`
...
That keeps the accepted `5 public / 7 total` floor governable as a stable
