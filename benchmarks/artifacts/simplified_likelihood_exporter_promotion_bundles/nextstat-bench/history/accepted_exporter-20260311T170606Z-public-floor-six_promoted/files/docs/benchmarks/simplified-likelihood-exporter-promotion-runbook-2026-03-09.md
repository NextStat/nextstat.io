...
- committed exporter matrix case count is at least `6`
- committed exporter matrix includes at least `5 public reinterpretation-style cases`
...
The accepted `5 public / 7 total` floor is refreshed:
...
Current March 9, 2026 committed exporter evidence meets those thresholds with:

- `export_matrix_case_count = 7`
- `export_matrix_public_reinterpretation_style_case_count = 5`
- `min_net_end_to_end_upper_limit_speedup = 2.0821942313909845x`
- `overall_min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
- `public_reinterpretation_style_min_net_end_to_end_upper_limit_speedup = 0.9648766256597925x`
