...
- export matrix case count: `8`
- export matrix case kinds: `public_reinterpretation_style`, `synthetic`
- export matrix public reinterpretation-style case count: `6`
...
- export matrix max `q_mu` absolute difference: `0.09089073579143658`
- export matrix max upper-limit ratio deviation from `1.0`: `0.0093663653819136`
- export matrix overall minimum net end-to-end upper-limit speedup: `0.9434751728263177x`
- export matrix synthetic control minimum net end-to-end upper-limit speedup: `2.0581999472135606x`
- export matrix public reinterpretation-style minimum net end-to-end upper-limit speedup: `0.9434751728263177x`
