#!/usr/bin/env python3
"""Ordinal regression suite runner.

Writes:
- per-case JSON files (nextstat.ordinal_benchmark_result.v1)
- a suite index JSON (nextstat.ordinal_benchmark_suite_result.v1)
"""
...
_CASES = [
    {"case_id": "ordered_logit_1k", "kind": "ordered_logit", "n": 1000, "repeat": 50},
    {"case_id": "ordered_logit_10k", "kind": "ordered_logit", "n": 10000, "repeat": 20},
    {"case_id": "ordered_logit_100k", "kind": "ordered_logit", "n": 100000, "repeat": 5},
    {"case_id": "ordered_probit_1k", "kind": "ordered_probit", "n": 1000, "repeat": 50},
    {"case_id": "ordered_probit_10k", "kind": "ordered_probit", "n": 10000, "repeat": 20},
    {"case_id": "ordered_probit_100k", "kind": "ordered_probit", "n": 100000, "repeat": 5},
]

_SMOKE_CASES = [
    {"case_id": "ordered_logit_1k", "kind": "ordered_logit", "n": 1000, "repeat": 5},
    {"case_id": "ordered_probit_1k", "kind": "ordered_probit", "n": 1000, "repeat": 5},
]
...
def main() -> int:
    ...
    index = {
        "schema_version": "nextstat.ordinal_benchmark_suite_result.v1",
        "suite": "ordinal",
        "meta": meta,
        "cases": index_cases,
        "summary": {"n_cases": len(index_cases), "n_ok": n_ok, "n_warn": n_warn, "n_failed": n_failed, "worst_case": worst_case},
    }
    (out_dir / "ordinal_suite.json").write_text(json.dumps(index, indent=2, sort_keys=True) + "\n")
