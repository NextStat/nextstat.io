...
SCHEMA_MAP = {
    ...
    # Phase 1 suites (Apex2 coverage expansion)
    "nextstat.ic_survival_benchmark_result.v1": "manifests/schema/ic_survival_benchmark_result_v1.schema.json",
    "nextstat.ic_survival_benchmark_suite_result.v1": "manifests/schema/ic_survival_benchmark_suite_result_v1.schema.json",
    "nextstat.competing_risks_benchmark_result.v1": "manifests/schema/competing_risks_benchmark_result_v1.schema.json",
    "nextstat.competing_risks_benchmark_suite_result.v1": "manifests/schema/competing_risks_benchmark_suite_result_v1.schema.json",
    "nextstat.garch_family_benchmark_result.v1": "manifests/schema/garch_family_benchmark_result_v1.schema.json",
    "nextstat.garch_family_benchmark_suite_result.v1": "manifests/schema/garch_family_benchmark_suite_result_v1.schema.json",
    "nextstat.ordinal_benchmark_result.v1": "manifests/schema/ordinal_benchmark_result_v1.schema.json",
    "nextstat.ordinal_benchmark_suite_result.v1": "manifests/schema/ordinal_benchmark_suite_result_v1.schema.json",
    "nextstat.gamma_tweedie_benchmark_result.v1": "manifests/schema/gamma_tweedie_benchmark_result_v1.schema.json",
    "nextstat.gamma_tweedie_benchmark_suite_result.v1": "manifests/schema/gamma_tweedie_benchmark_suite_result_v1.schema.json",
    "nextstat.lmm_benchmark_result.v1": "manifests/schema/lmm_benchmark_result_v1.schema.json",
    "nextstat.lmm_benchmark_suite_result.v1": "manifests/schema/lmm_benchmark_suite_result_v1.schema.json",
    "nextstat.pk_3cpt_benchmark_result.v1": "manifests/schema/pk_3cpt_benchmark_result_v1.schema.json",
    "nextstat.pk_3cpt_benchmark_suite_result.v1": "manifests/schema/pk_3cpt_benchmark_suite_result_v1.schema.json",
    "nextstat.ode_pk_benchmark_result.v1": "manifests/schema/ode_pk_benchmark_result_v1.schema.json",
    "nextstat.ode_pk_benchmark_suite_result.v1": "manifests/schema/ode_pk_benchmark_suite_result_v1.schema.json",
    "nextstat.pd_benchmark_result.v1": "manifests/schema/pd_benchmark_result_v1.schema.json",
    "nextstat.pd_benchmark_suite_result.v1": "manifests/schema/pd_benchmark_suite_result_v1.schema.json",
    # Snapshot artifacts
