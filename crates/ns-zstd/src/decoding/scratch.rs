...
use super::flat_decode_buffer::FlatDecodeBuffer;
...
impl DecoderScratch {
    pub fn new(window_size: usize) -> DecoderScratch {
        DecoderScratch {
            huf: HuffmanScratch { table: HuffmanTable::new() },
            fse: FSEScratch::new(),
...
impl HuffmanScratch {
    pub fn new() -> HuffmanScratch {
        HuffmanScratch { table: HuffmanTable::new() }
    }
}
