...
impl CounterRng {
    ...
    fn from_seed_scenario(seed: u64, scenario_id: u64) -> Self {
        ...
        Self { key0: splitmix64(base), key1: splitmix64(base ^ 0xA5A5_A5A5_5A5A_5A5A), draw_idx: 0 }
    }

    #[inline]
    fn next_u64(&mut self) -> u64 {
        let x = self.key0 ^ self.key1 ^ self.draw_idx.wrapping_mul(0x9E3779B97F4A7C15);
...
mod tests {
    ...
    fn test_cpu_default_chunk_size_is_10m_plus() {
        const _: () = assert!(DEFAULT_CHUNK_SIZE >= 10_000_000);
    }
