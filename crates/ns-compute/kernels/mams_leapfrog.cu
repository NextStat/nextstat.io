...
{
    switch (__mams_model_id) {
        case 3: return nll_glm_logistic_warp_shmem(x, dim, s_X_col, s_y, n_obs, n_feat, lane_id);
...
{
    switch (__mams_model_id) {
        case 3: grad_glm_logistic_warp_shmem(x, grad, dim, s_X_col, s_y, n_obs, n_feat, lane_id); break;
