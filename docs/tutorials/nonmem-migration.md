...
| `METHOD=0` (FO) | `nextstat.nlme_foce(..., method="fo")` | First-order approximation |
...
| Time-varying covariates | Partial: `1cpt_oral` in FOCE/SAEM |
| IOV (inter-occasion variability) | Partial: `1cpt_oral` in FOCE/SAEM |
