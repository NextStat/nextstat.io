...
- Missing data: `docs/tutorials/phase-9-missing-data.md`
- Survival analysis: `docs/tutorials/phase-9-survival.md`

Reference surfaces:

- Python API: `docs/references/python-api.md`
- CLI: `docs/references/cli.md`

If you're integrating NextStat into automation/agents:
