...
- Diff-in-diff + event study: `docs/tutorials/phase-12-did-event-study.md`
- IV / 2SLS: `docs/tutorials/phase-12-iv-2sls.md`
- AIPW (doubly-robust): `docs/tutorials/phase-12-aipw.md`
- Time series (state space / Kalman / EM): `docs/tutorials/phase-8-timeseries.md`
