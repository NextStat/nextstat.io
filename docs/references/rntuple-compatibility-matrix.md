...
| Host benchmark evidence | `ns-root` vs ROOT decode throughput (`epyc-node`) | `tests/fixtures/rntuple_bench_large_primitive.root` | verified | Repro note and commands: `docs/benchmarks/rntuple-epyc-node-2026-02-16.md` |
