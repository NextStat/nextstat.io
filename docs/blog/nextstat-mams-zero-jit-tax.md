...
All values in this table are **3-seed medians** for seeds `42/123/777`.
...
Another contributor is execution behavior on fixed-shape batched loops: some paths can spend gradients on steps that are no longer useful after divergence conditions, while NS kernels apply strict early termination in the sampler path. This affects the ESS/grad denominator directly.
...
Canonical V100 environment snapshot (from `v100_v096_builtinwarmup_3seed_20260218T224654Z/seed_42/gpu_triple_bench.json`):

- Python: `3.12.3`
- Rust: `rustc 1.93.0 (2026-01-19)`
- CUDA toolkit: `13.0` (`V13.0.88`)
- GPU: `Tesla V100-PCIE-16GB` (driver `580.95.05`, CC `7.0`, `16 GB`)
- JAX/JAXlib: `0.9.0.1 / 0.9.0.1`
- BlackJAX: `1.3`
- ArviZ: `0.23.4`
- NumPy/SciPy: `2.4.0 / 1.17.0`

Canonical EPYC run configuration (from `epyc-mams-suite.json` `config`):

- Hardware: `AMD EPYC 7502P, 32 cores / 64 threads, 128 GB RAM`
- Sampler config: `n_chains=4`, `n_warmup=1000`, `n_samples=1000`, `target_accept=0.9`, `eps_jitter=0.1`
- Seeds: `42, 123, 777`
