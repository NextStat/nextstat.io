...
- runnable seed implementation: **available**
- harness directory: `benchmarks/nextstat-public-benchmarks/suites/ml/`
...
- `benchmarks/nextstat-public-benchmarks/env/python/requirements-ml-jax-cpu.txt`
- `benchmarks/nextstat-public-benchmarks/env/python/requirements-ml-jax-cuda12.txt`
