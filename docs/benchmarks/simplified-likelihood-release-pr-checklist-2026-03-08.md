...
- [ ] promotion evidence bundle and promotion evidence check schemas are versioned and published
- [ ] promotion bundle persistence report schema is versioned and published
...
- [ ] current `promotion_evidence.json` exists and is linked from the snapshot note
- [ ] current `promotion_evidence_check.json` exists and is linked from the snapshot note
- [ ] accepted bundle exists under:
  - `benchmarks/artifacts/simplified_likelihood_promotion_bundles/nextstat-bench/accepted/`
- [ ] accepted bundle snapshot index exists and is linked from the snapshot note:
...
- [ ] `promotion_evidence_check.json` is `passed` with `require_promotion_ready=true`
- [ ] accepted bundle persistence report is present:
  - `promotion_bundle_promotion_report.json`
- [ ] release workflow uploads the simplified-likelihood promotion artifacts:
  - `.github/workflows/release.yml`
