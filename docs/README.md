...
- Simplified likelihood exporter stable evidence policy (release-facing admission policy + maintenance cadence for the accepted `6 public / 8 total` floor): `docs/benchmarks/simplified-likelihood-exporter-stable-evidence-policy-2026-03-09.md`
