        ...
        if depth == 2 {
            ...
            if cand0_match {
                ...
                if mlen0_bound >= MIN_MATCH {
                    ...
                    const EARLY_RETURN_LEN: usize = MIN_MATCH + 1;
            ...
            if cand1 != NONE_POS {
                ...
                if ctag1 == qtag && cand1_match {
                    ...
                    if do_scan {
                        ...
                        if mlen1_bound >= MIN_MATCH && (!has_best || mlen1_bound > best_len_bound) {
                            best_pos = cpos1;
