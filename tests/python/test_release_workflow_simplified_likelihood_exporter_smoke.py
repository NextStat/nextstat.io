...
def test_release_workflow_publishes_simplified_likelihood_exporter_promotion_artifacts() -> None:
    ...
    assert "dist/**/stable_promotion_decision.json" in publish_workflow
    assert "dist/**/stable_candidate_blocker_matrix.json" in publish_workflow
    assert "dist/**/stable_candidate_review_packet.json" in publish_workflow
    assert "dist/**/stable_evidence_policy.json" in publish_workflow
    assert "dist/**/stable_evidence_freshness_report.json" in publish_workflow
    assert "dist/**/stable_source_semantics_boundary.json" in publish_workflow
    assert "dist/**/stable_review_assessment.json" in publish_workflow
    assert "dist/**/export_public_validation_report.json" in publish_workflow
