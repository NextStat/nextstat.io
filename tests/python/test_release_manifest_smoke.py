...
def test_release_manifest_builds_prepare_contract() -> None:
    ...
    assert "dist/**/release_candidate_bundle_manifest.json" in manifest["candidate_artifacts"]["github_release_asset_globs"]
    assert "dist/**/release_manifest.json" in manifest["candidate_artifacts"]["github_release_asset_globs"]
