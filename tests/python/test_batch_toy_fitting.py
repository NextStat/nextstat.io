...
def test_batch_smoke(simple_model):
    ...
    results = nextstat.fit_toys_batch(simple_model, params, n_toys=10, seed=123)
...
def test_batch_convergence_rate(simple_model):
    ...
    params = simple_model.suggested_init()
    results = nextstat.fit_toys_batch(simple_model, params, n_toys=100, seed=42)
...
def test_batch_convergence_rate_complex(complex_model):
    ...
    results = nextstat.fit_toys_batch(complex_model, params, n_toys=50, seed=99)
...
def test_batch_reproducible(simple_model):
    ...
    params = simple_model.suggested_init()
    r1 = nextstat.fit_toys_batch(simple_model, params, n_toys=5, seed=77)
    r2 = nextstat.fit_toys_batch(simple_model, params, n_toys=5, seed=77)
...
def test_batch_different_seeds(simple_model):
    ...
    params = simple_model.suggested_init()
    r1 = nextstat.fit_toys_batch(simple_model, params, n_toys=5, seed=1)
    r2 = nextstat.fit_toys_batch(simple_model, params, n_toys=5, seed=2)
...
def test_batch_nll_finite(simple_model):
    ...
    params = simple_model.suggested_init()
    results = nextstat.fit_toys_batch(simple_model, params, n_toys=20, seed=456)
...
def test_batch_parameter_count(simple_model):
    ...
    params = simple_model.suggested_init()
    results = nextstat.fit_toys_batch(simple_model, params, n_toys=5, seed=789)
    n_params = len(params)
    for i, r in enumerate(results):
...
def test_batch_matches_fit_toys(simple_model):
    ...
    params = simple_model.suggested_init()
    results_batch = nextstat.fit_toys_batch(simple_model, params, n_toys=3, seed=55)
...
def test_batch_gpu_fallback_to_cpu(simple_model):
    """fit_toys_batch_gpu with device='cpu' works like regular batch."""
    params = simple_model.suggested_init()
    results = nextstat.fit_toys_batch_gpu(
