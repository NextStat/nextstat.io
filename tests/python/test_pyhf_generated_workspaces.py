...
def _assert_nll_parity(workspace: dict[str, Any], measurement_name: str, ns_timing):
    ...
    with ns_timing.time("pyhf:twice_nll:init"):
    ...
    with ns_timing.time("nextstat:nll:init"):
    ...
    with ns_timing.time("pyhf:twice_nll:shift"):
    ...
    with ns_timing.time("nextstat:nll:shift"):
    ...
    for poi in [0.0, 2.0]:
        ...
        with ns_timing.time("pyhf:twice_nll:poi"):
        ...
        with ns_timing.time("nextstat:nll:poi"):
